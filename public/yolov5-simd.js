...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'yolov5-simd.data';
      var REMOTE_PACKAGE_BASE = 'yolov5-simd.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_yolov5-simd.data');

      };
      Module['addRunDependency']('datafile_yolov5-simd.data');
   ...
   loadPackage({"files": [{"filename": "/yolov5n.ncnn.bin", "start": 0, "end": 3746084, "audio": 0}, {"filename": "/yolov5n.ncnn.param", "start": 3746084, "end": 3757880, "audio": 0}], "remote_package_size": 3757880, "package_uuid": "c6164eb7-8aba-4ff0-8969-c6c85f7f243a"});
...
var wasmBinaryFile = 'yolov5-simd.wasm';
...
/** @type {function(...*):?} */
var _yolov5_ncnn = Module["_yolov5_ncnn"] = createExportWrapper("yolov5_ncnn");
